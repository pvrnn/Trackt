...
| Monorepo   | **pnpm workspaces + Turborepo**                                        | apps/web, apps/api, apps/worker, apps/catalog (ADR-0001), apps/mobile (ADR-0008); packages/shared, packages/client, packages/db, packages/providers                                                                                            |
